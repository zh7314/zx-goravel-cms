...
type Admin struct {
	...
	Sex           int             `gorm:"column:sex;not null;default:10;comment:10保密20男30女" json:"sex"`                      // 10保密20男30女
	...
	Status        int             `gorm:"column:status;not null;default:10;comment:用户状态10是默认正常 20是禁止登陆" json:"status"`       // 用户状态10是默认正常 20是禁止登陆
	...
	IsAdmin       int             `gorm:"column:is_admin;not null;default:99;comment:是否管理员 10是，99不是" json:"is_admin"`        // 是否管理员 10是，99不是
