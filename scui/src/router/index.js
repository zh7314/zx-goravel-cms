...
function filterAsyncRouter(routerMap) {
	...
	routerMap.forEach(item => {
		...
		// 		title: item.name,
		// 		icon: item.icon,
		// 		type: item.is_menu == 10 ? 'menu' : null,
		// 		// tag: item.tag ?? null,
		// 	}
		// }
		...
		// router['children'] = item.children ? filterAsyncRouter(item.children) : null
		// router['component'] = loadComponent(item.component)
		// router['meta']['title'] = item.name
		// router['meta']['icon'] = item.icon
		// router['meta']['type'] = item.is_menu == 10 ? 'menu' : null
		// router['meta']['tag'] = item.tag??null
