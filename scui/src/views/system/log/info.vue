<template>
	...
	<el-main style="padding:0 20px;">
		<el-descriptions :column="1" border size="small">
			...
			<el-descriptions-item label="请求url不带参数">{{data.path}}</el-descriptions-item>
			<el-descriptions-item label="框架里定义的路由名称	">{{data.route_name}}</el-descriptions-item>
			<el-descriptions-item label="请求ip">{{data.request_ip}}</el-descriptions-item>
			<el-descriptions-item label="请求参数">{{data.data}}</el-descriptions-item>
			<el-descriptions-item label="管理员名称">{{data.admin_name}}</el-descriptions-item>
			<el-descriptions-item label="路由描述">{{data.route_desc}}</el-descriptions-item>
			<el-descriptions-item label="日志时间">{{data.create_at}}</el-descriptions-item>
		</el-descriptions>
