	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="id" border stripe>
				...
				<el-table-column label="标题" prop="title" show-overflow-tooltip min-width="200"></el-table-column>
				<el-table-column label="招聘链接url" prop="url" show-overflow-tooltip min-width="200"></el-table-column>
				...
				<el-table-column label="薪资范围" prop="salary_range" width="150"></el-table-column>
				<el-table-column label="工作地点" prop="place" width="150"></el-table-column>
				<el-table-column label="招聘人数" prop="number" width="150"></el-table-column>
...
export default {
	...
	data() {
		return {
			...
			apiObj: this.$API.website.jobOffers.list,
			selection: [],
			search: {}
		}
	},
	methods: {
		...
		async del(row) {
			...
			var res = await this.$API.website.jobOffers.delete.post(reqData)
