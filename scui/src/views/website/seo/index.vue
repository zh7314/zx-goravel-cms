	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="id" border stripe>
				...
				<el-table-column label="title" prop="title" show-overflow-tooltip min-width="200"></el-table-column>
				<el-table-column label="keyword" prop="keyword" show-overflow-tooltip min-width="250"></el-table-column>
				<el-table-column label="description" prop="description" show-overflow-tooltip min-width="250"></el-table-column>
				<el-table-column label="位置" prop="position" show-overflow-tooltip min-width="200"></el-table-column>
...
export default {
	...
	data() {
		return {
			...
			apiObj: this.$API.website.seo.list,
			selection: [],
			search: {}
		}
	},
	methods: {
		...
		async del(row) {
			...
			var res = await this.$API.website.seo.delete.post(reqData)
